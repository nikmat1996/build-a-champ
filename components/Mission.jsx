  ...
  return (
    <section className='px-[15px] pt-[72px] md:pt-[104px] lg:px-0' id='mission'>
      <div className='flex flex-col items-center w-full max-w-[1139px] mx-auto md:flex-row-reverse md:justify-between md:items-start'>
        ...
        <div className='w-full max-w-[629px] lg:-translate-y-10 pt-1 md:pt-0'>
            <div className='flex flex-row-reverse justify-center items-center md:flex-col md:items-start'>
                <Image src={mission} alt='gif image' className='w-[43px] h-[43px] md:w-[150px] md:h-[150px] translate-y-1 md:translate-y-0'/>
                <h2 className='text-2xl/9 font-bold py-2.5 md:text-[50px] md:leading-[57px] md:pb-[30px] translate-y-1'>{missionText.h2}</h2>
            </div>
