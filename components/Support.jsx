  ...
  return (
    <section className='relative px-5'>
      <div className='absolute inset-0  -z-10'>
        <Image src={support_bg} className='w-full h-full' />
      </div>
      <div className='flex flex-col items-center w-full max-w-[1139px] mx-auto md:flex-row  md:items-start py-12 md:py-20'>
        <Image src={support_lg} className='hidden md:block  self-center w-full scale-[2.3] translate-x-24 -translate-y-[98px]  max-w-[400px]'/>
        <div className='w-full max-w-[646px] text-white'>
            <div className='flex flex-row-reverse  justify-center items-center '>
                <Image src={support} className='w-[43px] h-[43px] md:w-[93px] md:h-[93px] '/>
